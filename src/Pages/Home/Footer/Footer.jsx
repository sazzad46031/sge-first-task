...
const Footer = () => {
    return (
        <div className='mt-[120px]'>
            <div>
                <div className='section-bg--shape_item'>
                ...
                <div className='bg-[#081831] px-4'>
                    ...
                    <div className='footer-3 leading-[150%] max-w-screen-xl mx-auto lg:px-[230px] px-6  '>
                        ...
                        <div className='lg:flex block gap-[23px]'>
                            ...
                            <div className='flex flex-wrap lg:flex-nowrap lg:gap-[23px] gap-10'>
                                <div>
                                    ...
                                    <p className='mulish-regular text-base text-[#CACACA] lg:mb-[50px] mb-0'>Sylhet Office</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className='mulish-regular text-base text-[#CACACA] mb-[22px]'>Abuja</p>
                                </div>
                                <div>
                                    <h3 className='mulish-bold text-base text-[#5093FB]'>Middle East Office</h3>
                                    <p className='mulish-regular text-base text-[#CACACA]'>Dubai</p>
                                </div>
                            </div>
                        </div>
                    </div>
